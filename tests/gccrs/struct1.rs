...
fn create_and_compare_structs() {
    ...
    unsafe {
        fprintf(
            stdout,
            "StructC: field1 = %u, field2 = %u, field3 = %u, field4 = %lld\n\0" as *const str
                as *const i8,
            struct_c.field1 as u32,
            struct_c.field2 as u32,
            struct_c.field3,
            struct_c.field4,
        );
        fprintf(
            stdout,
            "StructTransparent: field1 = %u\n\0" as *const str as *const i8,
            struct_transparent.0 as u32,
        );
        fprintf(
            stdout,
            "StructPacked: field1 = %u, field2 = %u, field3 = %u, field4 = %lld\n\0" as *const str
                as *const i8,
            struct_packed.field1 as u32,
            struct_packed.field2 as u32,
            struct_packed.field3,
            struct_packed.field4,
        );
        fprintf(
            stdout,
            "StructAligned: field1 = %u, field2 = %u, field3 = %u, field4 = %lld\n\0" as *const str
                as *const i8,
            struct_aligned.field1 as u32,
            struct_aligned.field2 as u32,
            struct_aligned.field3,
            struct_aligned.field4,
        );
        fprintf(
                stdout,
                "StructDefault: field1 = %d, field2 = %d, field3 = %d, field4 = %.2f, field5 = [%d, %d, %d, %d]\n\0" as *const str as *const i8,
                struct_default.field1 as u32,
                struct_default.field2 as u32,
